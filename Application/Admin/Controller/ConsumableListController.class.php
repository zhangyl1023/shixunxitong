...
class ConsumableListController extends MyController
{
    public function showConsumableList(){
        $data=M('consumable_list')->select();
        $this->assign('data',$data);
        $this->display();
    }
    public function qtdy(){
        $id=I('get.id');
        $numb=I('get.numb');
        echo $data=M('consumable_list')->where("id=$id")->setField('numb',"$numb");
    }

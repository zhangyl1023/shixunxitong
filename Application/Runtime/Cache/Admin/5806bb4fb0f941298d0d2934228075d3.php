            ...
            <div class="div_table div_tableAdd">
                <form action="/Admin/Privilege/addPrivilege" enctype="multipart/form-data" method="post" name="theForm">
                    <table width="40%" class="table teachAdd">
                        <tr>
                            <td class="teachAdd_left" colspan="2" style="color: #ff661e;font-size: 20px;">添加权限</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="teachAdd_right4">
                                <select name="parent_id">
                                    ...
                                    <option value="<?php echo $v['id'];?>"><?php echo str_repeat('--',$v['lev']); echo $v['priv_name'];?></option>
                                    <?php } ?>
                                </select>
                            </td>
                        </tr>

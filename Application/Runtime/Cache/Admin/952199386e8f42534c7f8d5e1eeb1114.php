            ...
            <div class="div_table">
                <table width="80%" class="table teachPlan" id="geuu">
                    ...
                    <tr class="hg">
                        ...
                        <td class="teachPlan_6" style="color:<?php if($v['status']==22){echo 'red';}else if($v['status']==2){echo '#0CDC25';}?>"><?php if($v['status']==1){echo '申请中';}else if($v['status']==2){echo '申请通过';}else if($v['status']==22){echo '申请退回';}?></td>
                        <td class="teachPlan_8">
                            <span class="teachPlan_ope" id="<?php echo $v['id']?>" onclick="<?php if($v['status']==2){echo 'cancel';}?>pass1(this,<?php echo $v['id'];?>,'<?php echo $v['suoshu']?>')">
                                <?php if($v['status']==1){echo '通过';}else if($v['status']==2){echo '取消通过';}else if($v['status']==22){echo '通过';}?>
                            </span>
                            <span class="teachPlan_del" id="<?php echo $v['id']?>"
                                  onclick="<?php if($v['status']==22){echo 'cancel';}?>back1(this,<?php echo $v['id']?>,'<?php echo $v['suoshu']?>')"><?php if($v['status']==1){echo '退回';}else if($v['status']==2){echo '退回';}else if($v['status']==22){echo '取消退回';}?>
                            </span>
                        </td>

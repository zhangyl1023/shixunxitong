        ...
        <div class="box">
            <div class="div_table">
                <table width="320px" class="table teachPlan" id="geuu">
                    <tr >
                        <td class="tableName" colspan="1" style="width: 60%">专业设置</td>
                    ...
                    <tr class="hg">
                        ...
                        <td class="teachPlan_8">
                            <span class="teachPlan_ope" id="<?php echo $v['id']?>" onclick="edit_table(this,<?php echo $v['id']?>,'Profession')">
                                编辑</span>
    ...
    function queding() {
        ...
        $.ajax({
            ...
            success: function (msg) {
                //msg返回值是修改数据库的结果
                if (msg > 0) {
                    window.location.href = "<?php echo U('showProfession');?>";
                }
            }
        });
    }

...
<div class="content">
    ...
    <section id="content_slide">
        <div class="box">
            <div class="div_table">
                <table width="40%" class="table teachPlan" id="geuu">
                    <tr>
                        <td class="tableName" colspan="2">角色权限</td>
                        <td class="tableNew" colspan="1" onclick="create()"><img src="/Public/img/新建.png"/>
                        </td>
                    </tr>
                    <tr>
                        <td class="teachPlan_4">角色</td>
                        <td class="teachPlan_6">权限</td>
                        <td class="teachPlan_8">操作</td>
                    </tr>
                    <?php foreach($data as $v){ ?>
                    <tr class="hg">
                        <td class="teachPlan_1"><?php echo $v['role_name']?></td>
                        <td class="teachPlan_1" style="text-align: left;">
                            <?php foreach($v['privilege'] as $vv){?>
                            <a <?php if($vv['lev']==0){echo "style='color:#4675FF;'";}else if($vv['lev']==1){echo "style='color:#FFAE1B;'";}?>><?php echo str_repeat('-',$vv['lev']*2).$vv['priv_name'].'<br>'?></a>
                            <?php }?>
                        </td>
                        <td class="teachPlan_8">
                            ...
                            <span class="teachPlan_del" id="<?php echo $v['id']?>"
                                  onclick="del_table(this,<?php echo $v['id']?>,'<?php echo $v['suoshu']?>')" aria-disabled="true">删除
                            </span>
                        </td>
                    </tr>
                    <?php } ?>
...
//    });
    function create(){
        window.location.href="<?php echo U('Role/addRole');?>";
    }
//
    //删除行*************************************************************************************************************

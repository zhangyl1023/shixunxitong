        ...
        <div class="box">
            <div class="div_table">
                <table width="460px" class="table teachPlan" id="geuu">
                    <tr>
                        <td class="tableName" colspan="3" style="width: 60%">所有课程</td>
                        <td class="tableNew" colspan="1" onclick="window.location.href='<?php echo U("sourse/addSourse");?>'"><img src="/Public/img/新建.png"/>
                        </td>
                    </tr>
                    <tr>
                        <th class="teachPlan_1">专业</th>
                        <th class="teachPlan_2">学期</th>
                        <th class="teachPlan_3">课程</th>
                    ...
                    <tr class="hg">
                        ...
                        <td class="teachPlan_8">
                            <span class="teachPlan_ope" id="<?php echo $v['id']?>"
                                  onclick="window.location.href='<?php echo U("sourse/modSourse",array('id'=>$v['id']));?>'">
                                编辑</span>
